...
TEMPLATES = [
    ...
    },
    {
        ...
        "description": "Buy ATM CE and sell a higher-strike CE. Capped-risk bullish debit spread on NIFTY.",
        "tags": ["options", "fno", "bullish", "spread"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            "builder": "legs",
            ...
            "legs": [
                {"action": "buy", "option_type": "CE", "strike_offset": 0, "lots": 75},
                {"action": "sell", "option_type": "CE", "strike_offset": 1, "lots": 75},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
        },
    },
    {
        "name": "NIFTY Long Straddle",
        "description": "Buy ATM CE and ATM PE to profit from a large move in either direction (volatility play).",
        "tags": ["options", "fno", "volatile", "long"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            "builder": "legs",
            ...
            "legs": [
                {"action": "buy", "option_type": "CE", "strike_offset": 0, "lots": 75},
                {"action": "buy", "option_type": "PE", "strike_offset": 0, "lots": 75},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
    ...
    },
    {
        ...
        "description": "Sell an OTM call spread and an OTM put spread. Collect premium in a range-bound market.",
        "tags": ["options", "fno", "range", "credit"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            "builder": "legs",
            ...
            "legs": [
                {"action": "sell", "option_type": "CE", "strike_offset": 1, "lots": 75},
                {"action": "sell", "option_type": "PE", "strike_offset": -1, "lots": 75},
                {"action": "buy", "option_type": "CE", "strike_offset": 2, "lots": 75},
                {"action": "buy", "option_type": "PE", "strike_offset": -2, "lots": 75},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
    ...
    },
    {
        ...
        "description": "Sell ATM CE and ATM PE to collect premium when implied volatility collapses.",
        "tags": ["options", "fno", "volatility", "credit"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            "builder": "legs",
            "instrument": {"symbol": "BANKNIFTY", "exchange": "NSE", "segment": "options"},
            "legs": [
                {"action": "sell", "option_type": "CE", "strike_offset": 0, "lots": 30},
                {"action": "sell", "option_type": "PE", "strike_offset": 0, "lots": 30},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
    ...
    },
    {
        ...
        "description": "Buy ATM PE and sell a lower-strike PE. Capped-risk bearish debit spread on BANKNIFTY.",
        "tags": ["options", "fno", "bearish", "spread"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            "builder": "legs",
            "instrument": {"symbol": "BANKNIFTY", "exchange": "NSE", "segment": "options"},
            "legs": [
                {"action": "buy", "option_type": "PE", "strike_offset": 0, "lots": 30},
                {"action": "sell", "option_type": "PE", "strike_offset": -1, "lots": 30},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
    ...
    {
        "name": "NIFTY Iron Butterfly",
        "description": "Sell the ATM straddle and buy wings. Maximum profit at the ATM strike.",
        "tags": ["options", "fno", "range", "credit"],
        "definition": {
            "version": 1,
            "timeframe": "1d",
            ...
            "instrument": {"symbol": "NIFTY", "exchange": "NSE", "segment": "options"},
            "legs": [
                {"action": "sell", "option_type": "CE", "strike_offset": 0, "lots": 75},
                {"action": "sell", "option_type": "PE", "strike_offset": 0, "lots": 75},
                {"action": "buy", "option_type": "CE", "strike_offset": 1, "lots": 75},
                {"action": "buy", "option_type": "PE", "strike_offset": -1, "lots": 75},
            ],
            "entry": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "exit": {"logic": "ALL", "conditions": [{"left": {"kind": "price", "price": "close"}, "op": "GT", "right": {"kind": "constant", "value": 0}}]},
            "position": {"quantity_type": "fixed", "quantity": 1, "direction": "long_only"},
